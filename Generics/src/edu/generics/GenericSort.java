...
public class GenericSort {
	public static void main(String[] args) {
		...
		//Create a GeometricObject array
				GeometricObject[] geoArray = new GeometricObject[4];
				geoArray[0] = new Circle();
				geoArray[1] = new Circle(2);
				geoArray[2] = new Rectangle(3,4);
				geoArray[3] = new Rectangle(5,2);
		//Sort the arrays
				sort(intArray);
				sort(doubleArray);
				sort(charArray);
		...
		// Display the sorted arrays
				...
				System.out.print("Sorted GeometricObject objects: ");
				printList(geoArray);
			}
